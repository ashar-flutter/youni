...
class YouniProSubscriptionDialog extends StatelessWidget {
  const YouniProSubscriptionDialog({super.key});

  static Future<void> show() {
    return Get.dialog(
      const YouniProSubscriptionDialog(),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomText(
                  'Complete your Youni Pro subscription',
                  fontSize: 11.px,
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      CustomText('\$9.99', fontSize: 16.5.sp),
                    ],
                  ),
                ),
